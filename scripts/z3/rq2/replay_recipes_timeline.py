...
def replay_recipes_timeline(
    ...
    # Merge final coverage into cumulative dictionaries (ensures monotonic growth)
    ...
    for func_key, call_count in final_coverage['function_counts'].items():
        cumulative_function_counts[func_key] = cumulative_function_counts.get(func_key, 0) + call_count

    # Compute final metrics from cumulative dictionaries
    ...
    final_checkpoint = {
        ...
        # Include cumulative coverage dictionaries for proper union during merge
        'line_coverage': cumulative_line_coverage.copy(),
        'branch_coverage': cumulative_branch_coverage.copy()
    }
